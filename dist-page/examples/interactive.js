...
const sections = [
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAccordion)({
            parent: c,
            id: "accMultiple",
            multiple: true,
            items: [
    ...
    },
    {
        ...
        render: (c) => {
            ...
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createTooltip)({ parent: c, id: "int-tt1", text: "Ez egy tooltip!", position: "top" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "br", parent: c });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createTooltip)({ parent: c, id: "int-tt2", text: "Als\xf3 tooltip", position: "bottom" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "br", parent: c });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createTooltip)({ parent: c, id: "int-tt3", text: "Bal tooltip", position: "left" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "br", parent: c });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createTooltip)({ parent: c, id: "int-tt4", text: "Jobb tooltip", position: "right" });
        },
    },
];
