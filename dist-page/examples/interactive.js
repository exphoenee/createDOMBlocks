...
const sections = [
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAccordion)({ parent: c, id: "a1", items: [
    ...
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => {
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createTooltip)({ parent: c, text: "Felső tooltip!", position: "top" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: "    " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createTooltip)({ parent: c, text: "Alsó tooltip", position: "bottom" });
        },
    },
];
