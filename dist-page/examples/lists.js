...
const sections = [
    (0,_page_components_index__WEBPACK_IMPORTED_MODULE_0__.example)({ title: "createUnorderedList", description: "Rendezetlen lista (ul) elemekből.",
    ...
    (0,_page_components_index__WEBPACK_IMPORTED_MODULE_0__.example)({ title: "createOrderedList", description: "Rendezett lista (ol) indulásos számmal.",
