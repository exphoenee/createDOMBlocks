...
(() => {
/*!*****************************************!*\
  !*** ./documentation/examples/lists.ts ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
const sections = [
    (0,_page_components_index__WEBPACK_IMPORTED_MODULE_0__.example)({ title: "createUnorderedList", description: "Rendezetlen lista (ul) elemekből.", component: _src_index__WEBPACK_IMPORTED_MODULE_1__.createUnorderedList,
        code: "createUnorderedList([\"Első\", \"Második\", \"Harmadik\", \"Negyedik\"], { parent, id: \"l1\" })",
        codeLang: "typescript" }, (parent) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createUnorderedList)(["Első", "Második", "Harmadik", "Negyedik"], { parent, id: "l1" })),
    (0,_page_components_index__WEBPACK_IMPORTED_MODULE_0__.example)({ title: "createOrderedList", description: "Rendezett lista (ol) indulásos számmal.", component: _src_index__WEBPACK_IMPORTED_MODULE_1__.createOrderedList,
        code: "createOrderedList([\"Tizedik\", \"Tizenegyedik\", \"Tizenkettedik\"], { parent, id: \"l2\", start: 10 })",
        codeLang: "typescript" }, (parent) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createOrderedList)(["Tizedik", "Tizenegyedik", "Tizenkettedik"], { parent, id: "l2", start: 10 })),
];
