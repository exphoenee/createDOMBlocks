...
const sections = [
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCustomDatePicker)({ parent: c, id: "dp1", labelText: "", placeholder: "Valássz dátumot...", onChange: (v) => console.log(v) }),
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCustomWeekPicker)({ parent: c, id: "wp1", labelText: "", placeholder: "Valássz hetet...", onChange: (v) => console.log(v) }),
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCustomMonthPicker)({ parent: c, id: "mp1", labelText: "", placeholder: "Valássz hónapot...", onChange: (v) => console.log(v) }),
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCustomDateTimePicker)({ parent: c, id: "dtp1", labelText: "", placeholder: "Valássz dátumot és időt...", onChange: (v) => console.log(v) }),
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCustomDateRangePicker)({ parent: c, id: "drp1", labelText: "", onChange: (s, e) => console.log(s, e) }),
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createDragAndDropFileInput)({ parent: c, id: "dd1", labelText: "", dropText: "Húzd ide a fájlokat", accept: [".jpg", ".png", ".pdf"], multiple: true, onFiles: (f) => console.log(f.map((x) => x.name)) }),
    },
];
