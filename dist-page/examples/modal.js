...
const sections = [
    {
        ...
        render: (c) => {
            ...
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createButton)({ parent: c, id: "modal-open-btn", text: "Modal megnyitása", click: () => (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.openModal)("docModal") });
        },
    },
];
