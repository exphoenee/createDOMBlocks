...
const sections = [
    {
        ...
        codeLang: "typescript",
        render: (c) => {
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a1", name: "Viktor Bozzay", size: "lg" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: " " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a2", name: "VB", size: "md" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: " " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a3", name: "V", size: "sm" });
        },
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => {
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a4", src: "https://i.pravatar.cc/100?img=1", size: "lg" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: " " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a5", src: "https://i.pravatar.cc/100?img=2", size: "md" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: " " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a6", src: "https://i.pravatar.cc/100?img=3", size: "sm" });
        },
    },
    {
        ...
        codeLang: "typescript",
        render: (c) => {
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a7", name: "AB", size: "lg", shape: "square" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: " " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a8", name: "CD", size: "md", shape: "square" });
            (0,domelemjs__WEBPACK_IMPORTED_MODULE_2__.createDOMElem)({ tag: "span", parent: c, text: " " });
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createAvatar)({ parent: c, id: "ava-a9", name: "EF", size: "sm", shape: "square" });
        },
    },
];
