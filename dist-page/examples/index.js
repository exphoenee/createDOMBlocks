...
(0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCard)({
    ...
    body: {
        tag: "div",
        children: [
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCodeBlock)({ language: "bash", code: "npm install createdomblocks" }),
            ...
            (0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCodeBlock)({ language: "html", code: '<link rel="stylesheet" href="https://unpkg.com/createdomblocks/dist/style.css" />\n<script src="https://unpkg.com/createdomblocks/dist/index.js"></script>' }),
        ],
    },
});
(0,_src_index__WEBPACK_IMPORTED_MODULE_1__.createCard)({
