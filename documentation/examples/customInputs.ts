...
const sections = [
  example(
    { title: "createCustomDatePicker", description: "Egy\xe9ni d\xe1tum kiv\xe1laszt\xf3 napt\xe1r popup-pal." },
  ...
  example(
    { title: "createCustomWeekPicker", description: "Egy\xe9ni h\xe9t kiv\xe1laszt\xf3." },
  ...
  example(
    { title: "createCustomMonthPicker", description: "Egy\xe9ni h\xf3nap kiv\xe1laszt\xf3." },
  ...
  example(
    { title: "createCustomDateTimePicker", description: "Egy\xe9ni d\xe1tum + id\u0151 kiv\xe1laszt\xf3." },
  ...
  example(
    { title: "createCustomDateRangePicker", description: "Egy\xe9ni d\xe1tumtartom\xe1ny kiv\xe1laszt\xf3." },
    (parent) => createCustomDateRangePicker({ parent, id: "drp1", labelText: "Tartom\xe1ny:", onChange: (s: string, e: string) => console.log(s, e) }),
  ),
  example(
    { title: "createDragAndDropFileInput", description: "Drag-and-drop f\xe1jl felt\xf6lt\u0151." },
